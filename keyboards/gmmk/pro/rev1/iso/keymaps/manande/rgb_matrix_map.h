...
This file is based on Jonavin's / gourdo1's rgb_matrix_map.h
(https://github.com/qmk/qmk_firmware/blob/master/keyboards/gmmk/pro/
rev1/iso/keymaps/gourdo1/rgb_matrix_map.h), with the omission of 
the custom RGB colors, RGB tests and the game rules.
